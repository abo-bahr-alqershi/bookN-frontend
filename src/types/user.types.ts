...
export interface UserDetailsDto {
  ...
  // بيانات حساب العميل وايضا العقار
  /** إجمالي عدد الحجوزات للمستخدم في حال كان الحساب عميل */
  /** إجمالي عدد الحجوزات للعقار في حال كان الحساب مالك او موظف */
  bookingsCount: number;
  /** عدد الحجوزات الملغاة للمستخدم في حال كان الحساب عميل */
  /** عدد الحجوزات الملغاة للعقار في حال كان الحساب مالك او موظف */
  canceledBookingsCount: number;
  /** عدد الحجوزات المعلقة للمستخدم في حال كان الحساب عميل */
  /** عدد الحجوزات المعلقة للعقار في حال كان الحساب مالك او موظف */
  pendingBookingsCount: number;
  /** تاريخ أول حجز للمستخدم في حال كان الحساب عميل */
  /** تاريخ أول حجز للعقار في حال كان الحساب مالك او موظف */
  firstBookingDate: string | null;
  /** تاريخ آخر حجز للمستخدم في حال كان الحساب عميل */
  /** تاريخ آخر حجز للعقار في حال كان الحساب مالك او موظف */
  ...
  /** عدد البلاغات ضده (على العقار) في حال كان الحساب مالك او موظف */
  reportsAgainstCount: number;
  /** إجمالي المدفوعات للمستخدم في حال كان الحساب عميل */
  /** إجمالي المدفوعات للعقار (سواء مالك او موظفين) في حال كان الحساب مالك او موظف */
  totalPayments: number;
  /** إجمالي المردودات للمستخدم في حال كان الحساب عميل */
  /** إجمالي المردودات للعقار (سواء مالك او موظفين) في حال كان الحساب مالك او موظف */
  totalRefunds: number;
  /** عدد المراجعات التي أجرىها المستخدم في حال كان الحساب عميل */
  /** عدد المراجعات التي أجراها العملاء على العقار في حال كان الحساب مالك او موظف */
  reviewsCount: number;

  // بيانات حساب المالك أو الموظف (Owner/Employee-only) للعقار
  /** وظيفة المستخدم (Owner أو Employee) */
  role?: 'Owner' | 'Employee';
  /** معرف العقار المرتبط */
  propertyId?: string;
  /** اسم العقار المرتبط */
  propertyName?: string;
  /** عدد الوحدات في العقار */
  unitsCount?: number;
  /** عدد صور العقار */
